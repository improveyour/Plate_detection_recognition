...
if __name__ == '__main__':
    ...
    parser.add_argument('--detect_model', nargs='+', type=str,
                        default='E:\graduate\Chinese_license_plate_detection_recognition-main\weights\my\plate_detect.pt',
                        help='model.pt path(s)')  # 检测模型
    parser.add_argument('--rec_model', type=str,
                        default='E:\graduate\Chinese_license_plate_detection_recognition-main\weights\my\plate_rec.pth',
                        help='model.pt path(s)')  # 车牌识别
    parser.add_argument('--is_color', type=bool, default=False, help='plate color')  # 是否识别颜色
    parser.add_argument('--image_path', type=str, default="imgs/my", help='source')  # 图片路径
